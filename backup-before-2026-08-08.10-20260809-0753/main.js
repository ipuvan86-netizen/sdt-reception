...
const ACTION_KEYS = ['patientId', 'name', 'kind', 'text', 'context', 'token', 'createdAt', 'doneAt', 'doneNote', 'updatedAt', 'section', 'due', 'assignee', 'repeat', 'stageDentist', 'stageReception', 'noteText', 'howTo', 'escalated', 'outcome', 'attempts', 'principleWritten', 'plink', 'mobile', 'feeSched', 'lastVisit', 'notesLog', 'dob', 'deleted', 'balanceText', 'balanceChecked', 'parked', 'parkedAt', 'chaseFlag'];
